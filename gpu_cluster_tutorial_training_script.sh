...
#SBATCH --gres=gpu:2 # use how many GPU
...
source /home/${STUDENT_ID}/miniconda3/bin/activate gluon

python code/train.py  --which_model Attention-BiAFCOM --keep_prob 0.8
